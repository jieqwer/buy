...
echo "<form class='layui-form' action='img_update1_check.php?id=$id' method='post' enctype='multipart/form-data'>

    <div class='layui-form-item'><label class='layui-form-label'>其它图</label>
        <div class='layui-input-inline' style='width:600px;float: left;margin-top: 20px;'>
            <input type='file' class='layui-btn' style='line-height: 40px'  name='picture'    autocomplete='off' class='layui-input'>
            <img src='../../../Reception/images/$row[20]' style='width: 200px;height: 200px;' id='userFace'>           
        </div>
