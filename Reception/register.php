        ...
        <div class="header-grid">
            <div class="header-grid-left animated wow slideInLeft" data-wow-delay=".5s">
                <ul>
                    ...
                    <li class="active"><i class="glyphicon glyphicon-book" aria-hidden="true"></i><a href="register.php">注册</a></li>
                </ul>
            </div>
...
<!-- register -->
	<div class="register">
		<div class="container">
			<h3 class="animated wow zoomIn" data-wow-delay=".5s">开始注册</h3>
			<div class="login-form-grids">
				<h5 class="animated wow slideInUp" data-wow-delay=".5s">基本信息</h5>
				<form action="register_check.php" method="post" class="animated wow slideInUp" data-wow-delay=".5s">
					<input type="text" name="surname"  placeholder="姓..." required=" " >
					<input type="text" name="lastname" placeholder="名..." required=" " >
				<h6 class="animated wow slideInUp" data-wow-delay=".5s">登录信息</h6>
					<input type="email" id="name" name="email" placeholder="填写您用于登录的邮箱" required=" " >
